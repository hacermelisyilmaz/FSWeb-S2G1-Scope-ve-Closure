...
/*Görev 1: macSkoru()
  ...
  skor parametresinin veya skorGuncelle fonksiyonunun kod bloğu içerisinde, fonksiyon dışından değiştirilmesini/
  manipüle edilmesini engellemek istiyorsak closure kullanmalıyız (örneğin skor doğrudan 100'e eşitlenebilir
  veya skor tek increment değil üç sayı artıracak şekilde değiştirilebilir). Bu durumda skor1 tercih edilmelidir.
*/
...
function takimSkoru() {
  let tSkoru = 0;
  while (tSkoru <= 10) {
    tSkoru = Math.floor(25 * Math.random());
  }
  return tSkoru;
}
